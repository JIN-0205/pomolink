...
export const clerkJa: LocalizationResource = {
  locale: "ja-JP",
  backButton: "戻る",
  ...
  commerce: {
    ...
    billedAnnually: "年払いで請求",
    billedMonthlyOnly: "月払いのみ",
    cancelSubscription: "サブスクリプションをキャンセル",
    cancelSubscriptionAccessUntil:
      "「{{plan}}」の機能は{{ date | longDate('ja-JP') }}まで利用できます。それ以降はアクセスできなくなります。",
    cancelSubscriptionNoCharge: "このサブスクリプションに課金されません。",
    cancelSubscriptionTitle: "{{plan}}サブスクリプションをキャンセルしますか？",
    cannotSubscribeMonthly:
      "このプランは月払いでは申し込めません。このプランを申し込むには年払いを選択する必要があります。",
    checkout: {
      description__paymentSuccessful: "お支払いが成功しました。",
      description__subscriptionSuccessful:
        "新しいサブスクリプションが設定されました。",
      downgradeNotice:
        "現在のサブスクリプションは請求期間終了まで維持され、その後、このプランに切り替わります。",
      emailForm: {
        subtitle:
          "購入を完了する前に、レシートを送信するメールアドレスを追加してください。",
        title: "メールアドレスを追加",
      },
      lineItems: {
        title__paymentMethod: "支払い方法",
        title__statementId: "ステートメントID",
        title__subscriptionBegins: "サブスクリプション開始",
        title__totalPaid: "合計支払額",
      },
      perMonth: "月額",
      title: "チェックアウト",
      title__paymentSuccessful: "支払いが成功しました！",
      title__subscriptionSuccessful: "成功！",
    },
    creditRemainder: "現在のサブスクリプションの残り期間分のクレジット。",
    defaultFreePlanActive: "現在、無料プランを利用しています",
    free: "無料",
    getStarted: "はじめる",
    ...
    switchToAnnual: "年払いに切り替え",
    switchToMonthly: "月払いに切り替え",
  ...
  formFieldHintText__slug:
    "スラグは人間が読めるユニークなIDです。URLで良く使われます。",
  ...
  organizationProfile: {
    ...
    billingPage: {
      paymentSourcesSection: {
        ...
        removeResource: {
          messageLine1: "{{identifier}}をこのアカウントから削除します。",
          messageLine2:
            "この支払いソースは利用できなくなり、それに依存する継続的なサブスクリプションは機能しなくなります。",
          successMessage: "{{paymentSource}}がアカウントから削除されました。",
          title: "支払い方法を削除",
        },
        title: "支払い方法",
      },
      start: {
        ...
        headerTitle__statements: "請求明細",
        headerTitle__subscriptions: "サブスクリプション",
      },
      subscriptionsListSection: {
        actionLabel__newSubscription: "プランを購読",
        actionLabel__switchPlan: "プランを切り替え",
        title: "サブスクリプション",
      },
    ...
    profilePage: {
      dangerSection: {
        deleteOrganization: {
          actionDescription:
            '続行するには "{{organizationName}}" と入力してください。',
    ...
    removeDomainPage: {
      ...
      messageLine2:
        "この後、ユーザーは自動的に組織に参加することができなくなります。",
  ...
  unstable__errors: {
    ...
    phone_number_exists:
      "この電話番号は既に使用されています。別の電話番号を試してください。",
  ...
  userProfile: {
    ...
    deletePage: {
      actionDescription:
        "続行するには下記に「Delete account」を入力してください。",
      confirm: "アカウント削除",
